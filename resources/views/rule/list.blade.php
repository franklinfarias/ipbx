...
@section('content')
    ...
    <div id="main-content">
        <div class="page-title"> <i class="icon-custom-left"></i>
            <h3><strong>List</strong> of the rules</h3>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="{{url('rule/create')}}" class="btn btn-primary m-t-10"><i class="fa fa-plus p-r-10"></i> Add a Rule</a>
                    </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    @foreach($rules as $obj)
                                        <tr>
                                            <td>{{$obj->name_rule}}</td>
                                            <td><a href="{{url('rule/edit/'.$obj->id_rule)}}" class="edit btn btn-sm btn-default"><i class="fa fa-pencil"></i> Edit</a></td>
