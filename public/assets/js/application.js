...
var setColor = function (color) {
    var color_ = 'color-'+color, path='';
    path = $('#theme-color').attr("path");
    $('#theme-color').attr("href", path + "/colors/" + color_ + ".css");
    if ($.cookie) {         
...
if($.cookie('style-color')){
    var color_ = 'color-'+$.cookie('style-color'), path='';
    path = $('#theme-color').attr("path");
    $('#theme-color').attr("href", path + "/colors/" + color_ + ".css");
}
else{
    var path='';
    path = $('#theme-color').attr("path");
    $('#theme-color').attr("href", path + "/colors/color-dark.css");
}
